...
<body>
    ...
    <section class="about">
        <h2>Sobre Nós</h2>
        <p>Bem-vindo à Biblioteca Virtual, onde exploramos o fascinante mundo dos livros e autores. Nosso objetivo é proporcionar uma experiência única de leitura online.</p>
        ...
        <p>Nossa missão é promover a educação, entretenimento e cultura por meio do acesso facilitado aos melhores livros. Visamos ser uma referência em bibliotecas virtuais, conectando leitores a histórias incríveis.</p>
